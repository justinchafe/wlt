...
public class Participant {
	...
	final String HEADER = "Participant Num, Slide Num, Start TimeStamp, End TimeStamp, End Time, First Click TimeStamp, First Click Time, Angle, Motion Selection, Appearance Selection";
	...
	public void addMidTime(int slideNum) {
		...
		String midTime = java.lang.Double.toString(mid - start);
	 	Element child = doc.createElement("FirstClickTime");
